...
function AdminDashboard() {
  ...
  useEffect(() => {
    const userEmail = user?.primaryEmailAddress?.emailAddress?.toLowerCase();
    const isAdmin = userEmail === 'saketh1607@gmail.com';
                  ...
                  <tr key={report.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 text-sm text-gray-900">
                      ...
                      <div className="text-gray-500 truncate max-w-xs">
                        {report.incidentDescription?.substring(0, 60) || 'No description provided'}
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      {report.reporterName}
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-screen overflow-y-auto">
            <div className="p-6">
              ...
              <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Victim Information */}
                <div>
                  <h3 className="text-sm font-medium text-gray-500">Victim Details</h3>
                  <div className="mt-2 space-y-4">
                    <div>
                      <span className="text-sm font-medium text-black">Name:</span>
                      <p className="mt-1 text-black">{selectedReport.victimName}</p>
                    </div>
                    <div>
                      <span className="text-sm font-medium text-black">Branch:</span>
                      <p className="mt-1 text-black">{selectedReport.victimBranch}</p>
                    </div>
                    <div>
                      <span className="text-sm font-medium text-black">Year:</span>
                      <p className="mt-1 text-black">{selectedReport.victimYear}</p>
                    </div>
                    <div>
                      <span className="text-sm font-medium text-black">Contact:</span>
                      <p className="text-black">{selectedReport.victimPhone}</p>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="mt-2 space-y-4">
                    <div>
                      ...
                      <p className="mt-1 text-black">{selectedReport.incidentDate}</p>
                    </div>
                    <div>
                      <span className="text-sm font-medium text-black">Location:</span>
                      <p className="mt-1 text-black">{selectedReport.incidentLocation}</p>
                    </div>
                    <div>
                      <span className="text-sm font-medium text-black">Reported On:</span>
                      <p className="mt-1 text-black">{formatDate(selectedReport.createdAt)}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6">
                <h3 className="text-sm font-medium text-gray-500">Perpetrators</h3>
                <div className="mt-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                  {selectedReport.perpetrators?.map((perp, index) => (
                    perp.name && (
                      <div key={index} className="bg-gray-50 p-4 rounded-lg">
                        <p className="font-medium text-black">Name:{perp.name}</p>
                        <p className="font-medium text-black"><p className="text-black">Branch&Year: </p>
                          {perp.branch && `${perp.branch} • `} 
                          {perp.year && `${perp.year}`}
                        </p>
                      </div>
                    )
              ...
              <div className="mt-6">
                ...
                <div className="mt-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                  {selectedReport.witnesses?.map((witness, index) => (
                    witness.name && (
                      <div key={index} className="bg-gray-50 p-4 rounded-lg">
                        <p className="font-medium text-black">Name: {witness.name}</p>
                        <p className="font-medium text-black">Contact: {witness.contact}</p>
                      </div>
                    )
                  ))}
                </div>
              ...
              <div className="mt-6">
                ...
                <p className="mt-2 whitespace-pre-line text-gray-700">
                  {selectedReport.incidentDescription}
                </p>
              </div>
